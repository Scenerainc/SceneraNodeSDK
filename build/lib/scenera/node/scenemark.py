"""
This contains the main SceneMark class and its methods for the Scenera Node SDK.
"""
...
class SceneMark:
    ...
    def __init__(
        ...
        # Verify that we get an address to return the SceneMark
